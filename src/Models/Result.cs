...
public class ErrorResult<T> : Result<T>, IErrorResult
{
    ...
    public ErrorResult(string message, T data) : this(message, data, Array.Empty<Error>())
    {
    }
    ...
    public ErrorResult(string message, T data, IReadOnlyCollection<Error> errors) : base(data)
    {
        Message = message;
        Success = false;
        Errors = errors ?? Array.Empty<Error>();
